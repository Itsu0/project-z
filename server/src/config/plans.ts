...
export const SLOT_TIERS: SlotTier[] = [
  { slots: 10,   label: 'Znajomi',            ram: '2 GB',  vcpu: 1,  disk: '20 GB',  transfer: '100 Mbps', priceMonthly: null, priceYearly: null },
  { slots: 25,   label: 'Mała społeczność',   ram: '2 GB',  vcpu: 1,  disk: '20 GB',  transfer: '100 Mbps', priceMonthly: null, priceYearly: null },
  { slots: 50,   label: 'Mała społeczność',   ram: '2 GB',  vcpu: 2,  disk: '40 GB',  transfer: '200 Mbps', priceMonthly: null, priceYearly: null },
  { slots: 100,  label: 'Średnia społeczność',ram: '4 GB',  vcpu: 2,  disk: '80 GB',  transfer: '500 Mbps', priceMonthly: null, priceYearly: null },
  { slots: 250,  label: 'Duża platforma',     ram: '8 GB',  vcpu: 4,  disk: '150 GB', transfer: '1 Gbps',   priceMonthly: null, priceYearly: null, recommended: true },
  { slots: 500,  label: 'Enterprise',         ram: '16 GB', vcpu: 8,  disk: '300 GB', transfer: '2 Gbps',   priceMonthly: null, priceYearly: null },
  { slots: 1000, label: 'Klaster',            ram: '32 GB', vcpu: 16, disk: '500 GB', transfer: '5 Gbps',   priceMonthly: null, priceYearly: null },
]
